...
type CronRunner struct {
	...
	envFactory func(string) *worker.Env
	done       chan struct{}
	wg         sync.WaitGroup
}
...
func (cr *CronRunner) dispatch(sched models.CronSchedule, siteID string, deployKey string, env *worker.Env) {
...
// Fields support: *, exact numbers, */N step values, comma-separated, ranges.
